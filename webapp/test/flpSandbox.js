		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comwakefernzflexcl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comwakefernzflexcl-display": {
								"semanticObject": "comwakefernzflexcl",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.wakefern.zflexcl",
									"url": sap.ui.require.toUrl("com/wakefern/zflexcl")
								}
							}
						}
					}
